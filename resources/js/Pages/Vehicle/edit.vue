                ...
                <div class="col-lg-2 col-md-2">
                    <div class="nav-wrapper-loc">
                        <ul class="nav nav-pills nav-fill flex-column" id="tabs-icons-text" role="tablist">
                            ...
                            <li class="mb-2 nav-item">
                                <a class="nav-link" id="upload-images-tab" data-toggle="tab" href="#upload-images"
                                    role="tab" aria-controls="upload-images" aria-selected="true">
                                    Upload Images</a>
                            </li>
                            <li class="mb-2 nav-item">
                    ...
                    <div class="shadow card">
                        <div class="card-body">
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade show" id="upload-images" role="tabpanel">
                                    <UploadImagesForm :vehicle_id="vehicle.id" />
                                </div>
