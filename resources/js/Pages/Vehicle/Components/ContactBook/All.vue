                ...
                <div class="row mb-2">
                    <div class="col-md-2 column__right___padding">
                        ...
                        <div class="input-group">
                            <input type="text" id="inp_contact_name" name="name" class="form-control form-control-sm"
                                v-model="contact.name" placeholder="Name" aria-label="name" aria-describedby="name"
                                required />
                        </div>
                        <small v-if="validationErrors.name" id="msg_contact_name"
                    ...
                    <div class="col-md-2 column__right___padding column__left___padding">
                        ...
                        <div class="input-group">
                            <input type="text" id="inp_contact_designation" name="designation"
                                class="form-control form-control-sm" v-model="contact.designation" placeholder="Designation"
                                aria-label="designation" aria-describedby="designation" required />
                        </div>
                        <small v-if="validationErrors.designation" id="msg_contact_designation"
                            class="text-danger form-text text-error-msg error">{{ validationErrors.designation }}</small>
                    </div>
                    <div class="col-md-3 column__right___padding column__left___padding">
                        <label>EMAIL</label>
                        <div class="input-group">
                            <input type="email" id="inp_contact_email" name="email" class="form-control form-control-sm"
                                v-model="contact.email" placeholder="Email" aria-label="email" aria-describedby="email"
                                required />
                        </div>
                        <small v-if="validationErrors.email" id="msg_contact_email"
                            class="text-danger form-text text-error-msg error">{{ validationErrors.email }}</small>
                    </div>
                    <div class="col-md-2 column__right___padding column__left___padding">
                        <label>MOBILE</label>
                        <div class="input-group">
                            <input type="text" id="inp_contact_mobile_no" name="mobile_no"
                                class="form-control form-control-sm" v-model="contact.mobile_no" placeholder="Mobile No."
                                aria-label="mobile_no" aria-describedby="mobile_no" required />
                        </div>
                        <small v-if="validationErrors.mobile_no" id="msg_contact_mobile_no"
                            class="text-danger form-text text-error-msg error">{{ validationErrors.mobile_no }}</small>
                    </div>
                    <div class="col-md-2 column__right___padding column__left___padding">
                        <label>LAND</label>
                        <div class="input-group">
                            <input type="text" id="inp_contact_land_no" name="land_no" class="form-control form-control-sm"
                                v-model="contact.land_no" placeholder="Land No." aria-label="land_no"
                                aria-describedby="land_no" required />
                        </div>
                        <small v-if="validationErrors.land_no" id="msg_contact_land_no"
                            class="text-danger form-text text-error-msg error">{{ validationErrors.land_no }}</small>
                    </div>
            ...
            <div>
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            <tr v-for="contact in contacts" :key="contact.id" :class="rowClass">
