                ...
                <div class="container-fluid">
                    <div class="header-body">
                        <div class="row align-items-center mb-3 mt-3">
                            ...
                            <div class="col-lg-4 text-right" v-if="can('create_unit_measurements')">
                    ...
                    <div class="table-responsive">
                        <div class="d-flex flex-row mb-3 rounded">
                            <div class="left d-flex">
                                ...
                                <div class="p-2 border icon_item" v-if="can('active_unit_measurements')">
                                    <a @click.prevent="
                                ...
                                <div class="p-2 border icon_item" v-if="can('inactive_unit_measurements')">
                                    <a @click.prevent="
                                ...
                                <div class="p-2 border icon_item" v-if="can('delete_unit_measurements') && this.checkUOMItems.length > 0">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr v-for="unit in units" :key="unit.id" :class="rowClass">
                                    ...
                                    <td class="text-right">
                                        <a href="javascript:void(0)" v-if="can('update_unit_measurements')" class="p-2" @click.prevent="editUnit(unit.id)">
                                            <i class="fas fa-pencil text-ash" aria-hidden="true"></i>
                                        </a>
                                        <a href="javascript:void(0)" v-if="can('delete_unit_measurements')" @click.prevent="deleteUnit(unit.id)" class="p-2">
                            ...
                            <div class="card-plain">
                                <div class="card-body m-3">
                                    <form role="form text-left" @submit.prevent="createUnit" enctype="multipart/form-data">
                                        ...
                                        <div class="text-right mt-2" v-if="can('create_unit_measurements')">
                                            <button type="submit"
                            ...
                            <div class="card-plain">
                                <div class="card-body m-3">
                                    <form role="form text-left" @submit.prevent="updateUnit" enctype="multipart/form-data">
                                        ...
                                        <div class="text-right mt-4" v-if="can('update_unit_measurements')">
            ...
            try {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        axios.post(route("units.changeStatus", id));
                        this.reload();
