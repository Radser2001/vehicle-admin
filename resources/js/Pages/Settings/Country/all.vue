                ...
                <div class="container-fluid">
                    <div class="header-body">
                        <div class="row align-items-center mb-3 mt-3">
                            ...
                            <div class="col-lg-4 text-right" v-if="can('create_countries')">
                            ...
                            <div class="table-responsive">
                                <div class="d-flex flex-row mb-3 rounded">
                                    <div class="left d-flex">
                                        ...
                                        <div class="p-2 border icon_item" v-if="can('active_countries')">
                                        ...
                                        <div class="p-2 border icon_item" v-if="can('inactive_countries')">
                                            <a @click.prevent="
                                        ...
                                        <div class="p-2 border icon_item" v-if="this.checkCountryItems.length > 0 && can('delete_countries')">
                            ...
                            <div class="card-plain">
                                <div class="card-body m-2">
                                    <form role="form text-left" @submit.prevent="createCountries"
                                        ...
                                        <div class="text-right mt-2" v-if="can('create_countries')">
                            ...
                            <div class="card-plain">
                                <div class="card-body m-2">
                                    <form role="form text-left" @submit.prevent="updateCountry"
                                        ...
                                        <div class="text-right mt-2" v-if="can('update_countries')">
